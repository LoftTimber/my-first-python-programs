...
print ("My "+person1+" and I are having an apple "+v1+" contest this year.")
print ("Every "+season1+" we go to "+person2+"'s farm to pick "+number1+" apples.")
print ("This year "+person3+" wants to make "+food1+", so we need alot.")
...
print ("Well actually I had one more then him, but it had a "+color1+" worm in it.")
